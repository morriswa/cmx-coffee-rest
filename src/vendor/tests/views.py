...
class VendorApplicationRequestTests(unittest.TestCase):
...
class VendorApplicationResponseTests(unittest.TestCase):
...
class CoffeeBeanCharacteristicsTests(unittest.TestCase):
...
class CreateProductRequestTests(unittest.TestCase):
...
class UpdateProductRequestTests(unittest.TestCase):
...
class VendorProductResponseTests(unittest.TestCase):
...
class VendorInformationTests(unittest.TestCase):
